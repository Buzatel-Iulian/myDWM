...
//	{ col_gray1, "sb-mpc",				0,		26},
	{ col_gray2, "cat /sys/class/thermal/thermal_zone0/temp",			0,		11},
//	{ col_gray3, "sb-tasks",			10,		12},
	{ col_gray4, "pwd",			0,		13},
	{ col_cyan, "echo 'hello'",	0,		14},
};
...
static const char *roficmd[]  = { "rofi", "-show", "combi", "-switchers", "combi,ssh", "-combi-modi", "window,drun", "-show-icons", "-no-cycle", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ NULL,                      XK_Super_L,     spawn,          {.v = roficmd }},
